        ...
        <div className="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-xl border border-[#E8E6E1] overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="p-5 border-b border-[#E8E6E1]">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-[#2D3436]">{user.nickname || "用户"}</h3>
                <p className="text-sm text-[#636E72]">ID: {user.secondmeUserId.slice(0, 8)}...</p>
              </div>
            </div>
          </div>
          ...
          {/* 兴趣标签 */}
          <div className="p-5 border-b border-[#E8E6E1]">
            <h4 className="text-sm font-medium text-[#636E72] mb-3">兴趣标签</h4>
            {loadingShades ? (
