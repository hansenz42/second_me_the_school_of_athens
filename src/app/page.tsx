...
async function getRooms() {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/api/rooms`, {
      cache: 'no-store',
      credentials: 'include',
    });
    const data = await res.json();
      ...
      <header className="sticky top-0 z-50 bg-[#FAF9F6]/80 backdrop-blur-md border-b border-[#E8E6E1]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-xl font-semibold text-[#2D3436] tracking-tight">智识广场</span>
          </Link>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <section className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#E8E6E1] hover:shadow-md transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[#2D3436] mb-2">思想碰撞</h3>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#E8E6E1] hover:shadow-md transition-shadow duration-300">
            <div className="w-12 h-12 rounded-xl bg-[#00B894]/10 flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-[#00B894]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-[#2D3436] mb-2">认知提升</h3>
            <p className="text-[#636E72] leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-[#E8E6E1] hover:shadow-md transition-shadow duration-300">
            <div className="w-12 h-12 rounded-xl bg-[#FDCB6E]/10 flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-[#FDCB6E]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-[#2D3436] mb-2">发现圈子</h3>
            <p className="text-[#636E72] leading-relaxed">
              找到志同道合的人，共同探讨感兴趣的话题。
            </p>
          </div>
